export default class Timer {
	...
	static getHTML() {
		return `
			<span class="timer__part">Guerra - </span>
			<span class="timer__part timer__part--minutes">00</span>
			<span class="timer__part">:</span>
			<span class="timer__part timer__part--seconds">00</span>
			<br>
			<span class="timer__part">Respawn en: </span>
			<span class="timer2 timer__part--respawn" >00</span>
			<br>
			<span class="timer__part" >----(</span>
			<span class="timer3 timer__part--nextmins">00</span>
			<span class="timer3">:</span>
			<span class="timer3 timer__part--nextsecs">00</span>
			<span class="timer__part">)----</span>
		`;
	}
}
